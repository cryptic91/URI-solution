...
//     if(n%4==0 && n%100!=0 || n%400==0) printf("This is leap year\n");

//     else if(n%15==0) printf("This is huluculu festival year\n");

//     else if(n%55==0) printf("This is bulukulu festival year\n");
